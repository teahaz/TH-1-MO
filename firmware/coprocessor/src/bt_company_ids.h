 ...
 * bt_company_ids.h
 *
 * Bluetooth SIG Company Identifiers (Manufacturer IDs).
 *
 * Auto-generated from the Nordic Semiconductor Bluetooth Numbers Database:
 ...
 * Entry count: 4003
 *
 * Entries are sorted ascending by `code`, so a binary search over the
 * table is valid. Note that the last entry (code 0xFFFF) is the SIG
 * reserved "no Device ID" sentinel.
 *
 * This file is encoded as UTF-8 because a small number of company names
 * contain accented Latin characters (é, ü, Ó, etc.) and full-width
 * parentheses. Compile with a toolchain that accepts UTF-8 in string
 * literals, or post-process the strings if you need strict ASCII.
 *
 * Copyright (c) 2019 - 2020, Nordic Semiconductor ASA. All rights reserved.
 * Licensed under the 3-Clause BSD License. See third-party/BSD-3-Clause-NordicSemiconductor.txt
 * or the NOTICE file for the full license text.
 *
 * SPDX-License-Identifier: BSD-3-Clause
 */

#ifndef BT_COMPANY_IDS_H
#define BT_COMPANY_IDS_H
...
static const bt_company_id_t bt_company_ids[] = {
    { 0x0000, "Ericsson AB" },
...
#define BT_COMPANY_IDS_COUNT ((size_t)(sizeof(bt_company_ids) / sizeof(bt_company_ids[0])))

#endif /* BT_COMPANY_IDS_H */
